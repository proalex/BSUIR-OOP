...
namespace UI
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.Rows.Add(employee.Name, employee.SecondName,
                    employee.GetType().GetCustomAttribute<JobNameAttribute>().JobName,
                    employee.Qualification, employee.Task);
            }
        }
